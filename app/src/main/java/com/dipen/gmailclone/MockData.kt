...
import com.dipen.gmailclone.model.Account
import com.dipen.gmailclone.model.MailData
...
val accountList = listOf<Account>(
    Account(
        ...
        userName = "Dipen Jansari",
        email = "drjansari@gmail.com",
        unReadMails = 99
    ),
    Account(userName = "Rakesh Sharma", email = "rakesh@gmail.com", unReadMails = 80),
    Account(userName = "Vipul Goyal", email = "vipul@gmail.com", unReadMails = 99)
)